...
const Resume: FC = memo(() => {
  return (
    <Section className="bg-transparent" sectionId={SectionId.Resume}>
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/10 p-6 shadow-2xl shadow-black/30 backdrop-blur-xl sm:p-12">
        <div aria-hidden className="pointer-events-none absolute -top-12 left-1/2 h-40 w-40 -translate-x-1/2 rounded-full bg-orange-400/30 blur-3xl sm:h-56 sm:w-56" />
        <div aria-hidden className="pointer-events-none absolute bottom-[-20%] right-[-15%] h-64 w-64 rounded-full bg-purple-400/30 blur-3xl" />
